...
def create_app(test_config=None):
    ...
    from .blueprints.admin.crawler.config import test
    app.register_blueprint(test.bp)

    from .blueprints.admin.crawler.config import final
    app.register_blueprint(final.bp)

    from .blueprints.admin.news import test
    app.register_blueprint(test.bp)

    from .blueprints.admin.crawler import setting
    app.register_blueprint(setting.bp)

    from .blueprints.admin.news import final
    app.register_blueprint(final.bp)

    from .blueprints.admin import proxy
    app.register_blueprint(proxy.bp)

    from .blueprints.user import news
